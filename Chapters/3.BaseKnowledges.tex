...
\newpage
	...
	Có ba loại số nguyên (word, short và long) có định dạng giống hệt nhau, ngoại trừ chiều dài. Bảng~\ref{tb:DLFPU} cho độ chính xác và giới hạn của các kiểu dữ liệu và hình~\ref{fig:DinhDangLoaiDL} đưa ra các định dạng. Bảng~\ref{tb:MaHoaSoNguyen} đưa ra bảng mã của ba loại nguyên dạng nhị phân.
